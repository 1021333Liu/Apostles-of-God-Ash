...
本轮明确不需要生产新的 background。现有场景底图暂时够用，请把产能集中在 `walkable_props`、`foreground_occluders`、技能栏图标和掉落物 / 道具栏图标。
...
请按三层理解最终接入，但本轮只生产第二层和第三层：

```text
background：现有 16:9 场景底图，本轮不新增、不重画
...
- 不要饱和绿色草地。
- 不要赛博、二次元、Q 版、塑料感。
- 不要继续堆新的 16:9 大场景数量，本轮不要交付 background。
